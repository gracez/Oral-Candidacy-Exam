...
Unfortunately, for two and higher dimensional systems, no potential function necessarily exists, complicating the landscape analogy. Still, the next conjecture formalizes a sense in which intensity equals basin steepness. While this statement has not been proven, it seems likely to be true.  \todo{cite personal communication with Kate}
