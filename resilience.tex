...
Intuitively, an invariant set is one which stays put for all time. %while forward and backward invariant sets stay put in forward and backward time, respectively. 
